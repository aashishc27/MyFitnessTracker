...
import kotlinx.android.synthetic.main.expandable_carview.view.*
...
class ExpandableCardView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : LinearLayout(context, attrs, defStyleAttr) {
    ...
    private fun initView(context: Context) {
        //Inflating View
        LayoutInflater.from(context).inflate(R.layout.expandable_carview, this)
    }
    ...
    override fun onFinishInflate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
            elevation = Util.convertDpToPixels(context, 4f)
